class QueLayer extends eui.Component {
    private chooseA:eui.Image;
    private chooseB:eui.Image;
    private chooseC:eui.Image;
    private chooseD:eui.Image;

    private labelA:eui.Label;
    private labelB:eui.Label;
    private labelC:eui.Label;
    private labelD:eui.Label;

    private que:eui.Label;
